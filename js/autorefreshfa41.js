...
function executeAutoRefreshByPush() {
    ...
    pushPage = initializePushPage("http://bet.hkjc.com/info/include/js/commons/custom/", oddsPushIconDisplay, onEngineReady, onEngineLost);
    initializeEngine(pushPage, "http://bet.hkjc.com/info/include/js/commons/lightstreamer/", null, masterWinRef);
                        ...
                        if (matchArray[key + "H_1"] != undefined && matchArray[key + "H_1"] != null) {
                            ...
                            function sortFunction(a, b) {
                                if (a[3] === b[3]) {
                                    ...
                                    if (parseFloat(a[3].split('http://bet.hkjc.com/')[0]) < parseFloat(b[3].split('http://bet.hkjc.com/')[0]))
                                        return -1;
                                    else if (parseFloat(a[3].split('http://bet.hkjc.com/')[0]) > parseFloat(b[3].split('http://bet.hkjc.com/')[0]))
                                        return 1;
                                    else
                                        return (parseFloat((a[3] + "/0").split('http://bet.hkjc.com/')[1]) < parseFloat((b[3] + "/0").split('http://bet.hkjc.com/')[1])) ? -1 : 1;
                                }
                            }
        ...
        if (_inplay) {
            ...
            if (_sell) {
                ...
                if (_matchStage.toLowerCase() == "extratime")
                    imgPath += "http://common.hkjc.com/maint/generic.html";
